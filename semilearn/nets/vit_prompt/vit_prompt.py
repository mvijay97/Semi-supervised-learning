...
class PromptedVisionTransformer(nn.Module):
    ...
    def extract(self, x):
        ...
        # x = torch.cat((self.cls_token.expand(x.shape[0], -1, -1), x_prompt, x), dim=1)
...
def prompted_vit_tiny_patch2_32(pretrained=False, pretrained_path=None, **kwargs):
    """ ViT-Tiny (Vit-Ti/2)
    """
...
def prompted_vit_small_patch2_32(pretrained=False, pretrained_path=None, **kwargs):
    """ ViT-Small (ViT-S/2)
    """
...
def prompted_vit_small_patch16_224(pretrained=False, pretrained_path=None, **kwargs):
    """ ViT-Small (ViT-S/16)
    """
...
def prompted_vit_base_patch16_96(pretrained=False, pretrained_path=None, **kwargs):
...
def prompted_vit_base_patch16_224(pretrained=False, pretrained_path=None, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
